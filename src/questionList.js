const questionList = [
  {
    ...
    qs: [
      ...
      },
      {
        year: "1973",
        qtext:
          "Which radio station opened in 1973, becoming the first ever legal competitor to the BBC?",
        qImg: "",
      ...
      },
      {
        year: "1974",
        qtext:
          "Which show, featurning Glenda Jackson, was the most popular Christmas TV show in 1974?",
        qImg: "",
      ...
      },
      {
        year: "1975",
        qtext:
          "There was a referendum in 1975 open to all British voters. What was it about?",
        qImg: "",
      ...
      },
      {
        year: "1976",
        qtext:
          "Which band is widely accepted as releasing the UK's first Punk single on 22nd October 1976 with a song called 'New Rose'?",
        qImg: "",
      ...
      },
      {
        year: "1977",
        qtext:
          "Which team were relegated from football's First Division in 1977, seeing their goalkeeper join local rivals?",
        qImg: "",
      ...
      },
      {
        year: "1978",
        qtext:
          "By which extraordinary James Bond-esque method was the exiled Bulgarian author Georgi Markov assasinated in 1978?",
        qImg: "",
    ...
    qs: [
      {
        year: "1981",
        qtext:
          "In 1981 which two British athletes broke the world record for the mile three times in ten days?",
        qImg: "",
      ...
      },
      {
        year: "1985",
        qtext:
          "What was the name of the battery powered tricycle unveiled by Clive Sinclair?",
        qImg: "",
        answerA: "C1",
        answerB: "C3",
        answerC: "C3PO",
      ...
      },
      {
        year: "1986",
        qtext:
          "Which space shuttle tragically exploded 73 seconds after launch in 1986?",
        qImg: "",
        answerA: "Discovery",
        answerB: "Columbia",
        answerC: "Endeavour",
      ...
      },
      {
        year: "1987",
        qtext:
          "While playing for Tottenham Hotspur in the 1987 FA Cup Final, what part of Gary Mabbutt's body caused him and all Spurs fans distress?",
        qImg: "",
        answerA: "His face",
        answerB: "His big toe",
        answerC: "His knee",
      ...
      },
      {
        year: "1988",
        qtext:
          "Who preceded Gorbachev as Head of State of the Soviet Union in 1988?",
        qImg: "",
      ...
      },
      {
        year: "1989",
        qtext:
          "Which debut album sharing the same name as the band that recorded it, was released in 1989?",
        qImg: "",
        answerA: "Ride",
  ...
  },
  {
    ...
    qs: [
      ...
      },
      {
        year: "1992",
        qtext:
          "What title was dubbed on David Mellor in 1992 after he admitted to having an affair?",
        qImg: "",
      ...
      },
      {
        year: "1993",
        qtext:
          "In 1983 Kim Campbell was elected the first woman Prime Minister of which country?",
        qImg: "",
        answerA: "Canada",
        answerB: "Australia",
        answerC: "New Zealand",
      ...
      },
      {
        year: "1994",
        qtext:
          "Which Italian cruise ship, best known for its hijacking in 1985, sank in 1994?",
        qImg: "",
      ...
      },
      {
        year: "1996",
        qtext:
          "In 1996 what happened to Wallace and Gromit, causing distress to their owner, Nick Park?",
        qImg: "",
      ...
      },
      {
        year: "1997",
        qtext:
          "What was the popular name given to Daniel Hopper, an anti-road protester?",
        qImg: "",
        answerA: "Stig",
        answerB: "Crusty",
        answerC: "Swampy",
    ...
    qs: [
      {
        year: "2001",
        qtext:
          "Geri Halliwell's cover of \"It's Raining Men\" featured on the soudtrack of which film?",
        qImg: "",
        answerA: "Serendipity",
      ...
      },
      {
        year: "2002",
        qtext:
          "Which 2002 film set in the future was based on a short story by Philip K Dick?",
        qImg: "",
      ...
      },
      {
        year: "2005",
        qtext:
          "In 2005 The Sun caused a stir by publishing a photo of which 68 year old in his underpants?",
        qImg: "",
      ...
      },
      {
        year: "2006",
        qtext:
          "In 2006 it was announced that the murder of former KGB officer Alexander Litvinenko was due to poisoning by which chemical element?",
        qImg: "",
        answerA: "Plutonium",
        answerB: "Polonium",
        answerC: "Phosphorus",
      ...
      },
      {
        year: "2007",
        qtext:
          "In June 2007, which highly anticipated electronic gadget was finally released in the USA?",
        qImg: "",
        answerA: "Palm Pilot",
        answerB: "iPad",
        answerC: "iPhone",
      ...
      },
      {
        year: "2008",
        qtext:
          "Which bank became the first in Europe to be taken under state control due to the US subprime mortgage financial crisis in 2008?",
        qImg: "",
        answerA: "Northern Rock",
        answerB: "Brinks Matt",
        answerC: "Bradford and Bingley",
  ...
  },
  {
    ...
    qs: [
      ...
      },
      {
        year: "2012",
        qtext:
          "During the 2012 Olympics, which country was unable to view the opening ceremony in London on live TV?",
        qImg: "",
        answerA: "Ireland",
        answerB: "France",
        answerC: "China",
      ...
      },
      {
        year: "2013",
        qtext:
          "In 2013 which sporting event was delayed for 34 minutes thanks to a power outage",
        qImg: "",
      ...
      },
      {
        year: "2015",
        qtext:
          "In 2015 a BA flight turned around half an hour into the flight to Dubai because of what in a lavatory?",
        qImg: "",
      ...
      },
      {
        year: "2017",
        qtext:
          "Who in 2017 was appointed World Organisational Health Goodwill Ambassador, only for it to be revoked within days?",
        qImg: "",
      ...
      },
      {
        year: "2018",
        qtext:
          'In 2018 which country changed its constitution by removing limits for its leaders, thereby making the current incumbent "President for Life"?',
        qImg: "",
        answerA: "America",
        answerB: "Cuba",
        answerC: "Russia",
      ...
      },
      {
        year: "2019",
        qtext:
          "In 2019 England won the Cricket World Cup, but at which ground was it played?",
        qImg: "",
        answerA: "Headingley",
      ...
      },
      {
        year: "2020",
        qtext:
          "2020 saw the tragic end to the reign of Donald Trump.  Which of the following is not a quote of his?",
        qImg: "",
        answerA:
